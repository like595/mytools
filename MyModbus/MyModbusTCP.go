...
参数：ip，端口号，设备地址
*/
func (this *MyModbusTCP) Start(ip string, port, address int, modbusReceiveDataBackClient ModbusReceiveDataBackClient,
...
返回发送命令的索引
*/
func (this *MyModbusTCP) Read(funCode int, begin int, len int) int {
	ix := this.getIndex()
	data := make([]byte, 0)
	//索引
...
返回发送命令的索引
*/
func (this *MyModbusTCP) Write(funCode int, begin int, len int, sdata *[]byte) int {
	len = len / 2
	ix := this.getIndex()
	data := make([]byte, 0)
	//索引
...
接收数据回调函数
*/
func (this *MyModbusTCP) receiveDataBackClient(data []byte, len int) {
...
连接成功回调函数
*/
func (this *MyModbusTCP) connectBackClient() {
...
失去连接回调函数
*/
func (this *MyModbusTCP) disConnectBackClient() {
...
生成索引
*/
func (this *MyModbusTCP) getIndex() int {
	this.index += 1
	if this.index > 65535 {
		this.index = 0
	}
